...
namespace KUKUTAN
{
    ...
    public partial class SecondPage : Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // challengeランダムの場合の使用すうじをリセット
            for (short ii = 1; ii <= 9; ii++)
            {
                for (short tt = 1; tt <= 9; tt++)
                {
                    Module1.challengezyunban[ii, tt] = 0;
                }
            }

            for (short ii = 1; ii <= 81; ii++)
            {
                short p, q;
                Random rnd = new System.Random();
                do // 問題番号と同じじゅんじょに決まっているすうじを出題
                {
                    p = (short)(rnd.Next(9) + 1);
                    q = (short)(rnd.Next(9) + 1);
                }
                while (Module1.challengezyunban[p, q] != 0);

                Module1.challengezyunban[p, q] = ii;
            }
            // challengeランダムの場合の使用すうじをリセット　ここまで
